    ...
    <div class="col-sm-6">
      <form id="updatepwd_form">
        <div class="form-group">
          ...
          <input type="password" value="" name="pwd" class="form-control" placeholder="Enter password" id="pwd">
        </div>
        <div class="form-group">
          <label for="new_pwd">New Password:</label>
          <input type="password" value="" name="new_pwd" class="form-control" placeholder="Enter new password" id="new_pwd">
        </div>
      </form>
